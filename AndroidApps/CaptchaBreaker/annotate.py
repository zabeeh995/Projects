...
for (i, imagePath) in enumerate(imagePaths):
    ...
    print("[INFO] processing image {}/{}".format(i + 1,
                                                 len(imagePaths)))
    try:
        print("in for loooooooopppppppppppppppppppppppppppppppppppppppppppppppppppppp")
        ...
        for c in cnts:
            print("in contourrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr")
            ...
            key = chr(key).upper()
            dirPath = os.path.sep.join(["datset", key])
